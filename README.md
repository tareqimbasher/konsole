# Konsole
A .NET light-weight wrapper and utility for System.Console
...
## Why?
When writing applications geared for use with the console, we often end up rolling our own helpers for formatting output. This makes that job just a little bit easier.
...
![preview](https://github.com/tareqimbasher/konsole/blob/main/preview.png?raw=true)